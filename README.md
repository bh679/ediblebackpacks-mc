...
- Backpack storage renders as two 8×9 panels flanking the vanilla survival inventory
  screen (up to **144 slots**). Panels hide while the crafting recipe book is open.
...
| `maxSlots` | `144` | Cap on slots unlockable by eating backpacks (render cap 144) |
